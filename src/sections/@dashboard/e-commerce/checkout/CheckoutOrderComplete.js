...
import { deleteAllCart } from '../../../../redux/actions/E-commerceActions/cartActions';
// routes
...
export default function CheckoutOrderComplete({cartList, ...other}) {
  ...
  const HandlePDF = () => {
    ...
    Doc.autoTable({
      head: [['Produit','Prix' ,'Qte', 'Prix total']],
      body: rows
      ,
    })
    Doc.save('Order.pdf')
