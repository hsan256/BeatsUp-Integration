...
export function createEvent(newEvent) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.post('https://beatsup-project.herokuapp.com/addEvent', newEvent);
...
export function updateEvent(eventId, updateEvent) {
  return async () => {
    ...
    try {
      ...
      const response = await axios.patch(`https://beatsup-project.herokuapp.com/update/${eventId}`, updateEvent);
...
export function deleteEvent(eventId) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      axios.delete(`https://beatsup-project.herokuapp.com/delete/${eventId}`);
