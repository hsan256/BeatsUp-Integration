...
export default function ProductDetailsReview({ product, single }) {
  ...
  return (
    <>
      ...
      <Divider />
        ...
        <ProductDetailsReviewForm single ={single} onClose={handleCloseReviewBox} />


      <ProductDetailsReviewList single ={single} product={product} />
    </>
  );
}
