          ...
          <Grid item xs={12} md={4} sx={{ display: 'flex', alignItems: 'center' }}>
            <ContentStyle>
              ...
              <MotionInView variants={varFade().inUp}>
                ...
                >
                  We collected most popular songs. artists, soundtracks, etc. are all here. Just dive in!
                </Typography>
              </MotionInView>
              ...
              {[...Array(3)].map((_, index) => (
                ...
                >
                  <Image
                    ...
                    //   isLight ? 'light' : 'dark'
                    // }_${index + 1}.png`}
                    // src={`https://ipfs.io/ipfs/bafybeicy2wconk5ttijhpt3hgkabynrqpx5vfcvwhco3ocsmtgprtzgri4/${index + 1}.png`}
                    src={`https://preview.wolfthemes.live/app/uploads/sites/16/2018/08/k-disc-400x400.png`}
                  />
                </ScreenStyle>
              ))}
            </Box>
